    ...
    public static void main(String[] args){
        ...
        while(check_avl(system_time,at,n)){
            ...
            if(get_sm_pt_in != -1){
                ...
                wt[get_sm_pt_in] = tt[get_sm_pt_in]-store_bt[get_sm_pt_in];
                
                if(bt[get_sm_pt_in] == 0){
                   at[get_sm_pt_in] = -1;
                }
            }
            else{
        ...
        for(int i=0; i<n; i++){
            System.out.println(pid[i]+"   "+store_bt[i]+"   "+pt[i]+"   "+ct[i]+"   "+tt[i]+"   "+wt[i]);
        }
